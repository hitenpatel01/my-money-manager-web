export const environment = {
    ...
    darkTheme: false,
    urls: {
        authorizationPkce: 'https://m3.auth.us-east-1.amazoncognito.com/oauth2/authorize?response_type=code&client_id=4mstutl93bnan7gnrdff6t7ado&redirect_uri=http://localhost:4200&state={{STATE}}&code_challenge_method=S256&code_challenge={{CODE_CHALLENGE}}',
